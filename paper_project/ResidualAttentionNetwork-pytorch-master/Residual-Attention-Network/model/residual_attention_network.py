...
class ResidualAttentionModel_92_32input_update(nn.Module):
    ...
    def forward(self, x):
        ...
        Returns:
            输出了每一层的shape
            x_size torch.Size([96, 3, 32, 32])
            conv1 torch.Size([96, 32, 32, 32])
            residual_block1 torch.Size([96, 128, 32, 32])
            attention_module1 torch.Size([96, 128, 32, 32])
            residual_block2 torch.Size([96, 256, 16, 16])
            attention_module2 torch.Size([96, 256, 16, 16])
            attention_module2_2 torch.Size([96, 256, 16, 16])
            residual_block3 torch.Size([96, 512, 8, 8])
            attention_module3 torch.Size([96, 512, 8, 8])
            attention_module3_2 torch.Size([96, 512, 8, 8])
            attention_module3_3 torch.Size([96, 512, 8, 8])
            residual_block4 torch.Size([96, 1024, 8, 8])
            residual_block5 torch.Size([96, 1024, 8, 8])
            residual_block6 torch.Size([96, 1024, 8, 8])
            mpool2 torch.Size([96, 1024, 1, 1])
            out.view torch.Size([96, 1024])
            fc torch.Size([96, 10])
