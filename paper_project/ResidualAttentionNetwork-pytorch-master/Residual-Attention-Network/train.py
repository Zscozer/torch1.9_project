...
if __name__ == '__main__':
    ...
    # CIFAR-10 Dataset
    train_dataset = datasets.CIFAR10(root=r'C:\Anaconda\envs\pytorch\Pyproject\datasets',
                                   train=True,
                                   transform=transform,
                                   download=False)

    test_dataset = datasets.CIFAR10(root=r'C:\Anaconda\envs\pytorch\Pyproject\datasets',
                                  train=False,
    ...
    if is_train is True:
        ...
        for epoch in range(total_epoch):
            ...
            for i, (images, labels) in enumerate(train_loader):
                ...
                # print("hello")
                if (i+1) % 100 == 0:
                    print("Epoch [%d/%d], Iter [%d/%d] Loss: %.4f" %(epoch+1, total_epoch, i+1, len(train_loader), loss.data.item()))
